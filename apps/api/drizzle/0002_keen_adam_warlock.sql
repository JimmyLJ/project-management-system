...
ALTER TABLE "invitations" DROP CONSTRAINT IF EXISTS "invitations_invited_by_auth_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "workspace_members" DROP CONSTRAINT IF EXISTS "workspace_members_user_id_auth_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "workspaces" DROP CONSTRAINT IF EXISTS "workspaces_owner_id_auth_users_id_fk";--> statement-breakpoint
